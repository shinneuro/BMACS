function [vertices, fs_coords, hemisphere] = CBIG_RF_MNICoord2fsaverageVertexHemi(mni_coords, surf_mesh)
...
%     - hemisphere:
%                 1xN array of the N corresponding hemisphere location on fsaverage surface [0: left, 1: right]
%
% Example:
